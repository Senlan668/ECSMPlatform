...
public class SessionController {
    ...
    public BaseResult<SessionDetailVO> getSession(
    ...
    public BaseResult<PageResult<SessionListVO>> getSessionList(
        ...
        try {
            ...
            queryWrapper.likeRight(AiSession::getSessionId,
                    TenantResourceScope.conversationPrefix(tenantId, subjectId) + ".");
    ...
    public BaseResult<String> deleteSession(
            @PathVariable String conversationId,
            @RequestHeader("X-Tenant-Id") String tenantId,
            @RequestHeader("X-Subject-Id") String subjectId
    ) {
